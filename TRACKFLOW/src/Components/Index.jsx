...
function Index() {
    ...
    const handleAdd = () => {
        if (!text || !amount) return alert("Please Fill the Fields.");
                        ...
                        <div className="border-light px-5 py-4 rounded my-3">
                            <div className="">
                                ...
                                <div className="trans-card-wrap">
                                    {transactions.length === 0 ? (
                                        <div className="alert alert-danger text-center">No Transactions </div>
                                    ) : (
                                        transactions.map(item => (
                                            <div key={item.id} className="trans-card d-flex justify-content-between align-items-center border-light rounded p-2 mb-2 position-relative">
                                                ...
                                                <div className="d-flex align-items-center gap-3">
                                                    <span className={item.amount > 0 ? 'text-success fw-bold' : 'text-danger fw-bold'}>
                            ...
                            <div className="border-light px-5 py-4 rounded">
                                <div className="input-box">
                                    ...
                                    <input type="text" className="form-control border-light mb-3"
                                    placeholder='Enter Text' value={text} onChange={(e)=>setText(e.target.value)}/>
                                    <label className='form-label fw-bold'>
                                        Amount (Negative - expense,Positive - Income)
                                    </label>
                                    <input type="number" className="form-control border-light mb-3"
